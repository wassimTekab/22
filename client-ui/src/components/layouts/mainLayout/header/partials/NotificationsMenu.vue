...
export default defineComponent({
  ...
  setup() {
    const data1 = [
      {
        title: "Platform Alice",
        description: "Phase 1 development",
        time: "1 hr",
        icon: "svg/icons//teh008.svg",
        state: "primary",
      },
      {
      ...
      },
      {
        ...
        time: "5 hrs",
        icon: "svg/icons//fin006.svg",
        state: "warning",
      },
      {
        title: "Platform Redux",
        description: "New frontend admin theme",
        time: "2 days",
        icon: "svg/icons/fil023.svg",
        state: "success",
      },
      {
        title: "Platform Breafing",
        description: "Product launch status update",
        time: "21 Jan",
        icon: "svg/icons/map001.svg",
        state: "primary",
      },
      {
        title: "Banner Assets",
