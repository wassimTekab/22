        ...
        >
          ...
          >
            <template v-for="(menuItem, j) in item.pages" :key="j">
                  ...
                  <template v-for="(menuItem1, k) in menuItem.sub" :key="k">
                    ...
                    >
                      ...
                      >
                        ...
                        <span class="menu-title">{{ $t(menuItem1.sectionTitle) }}</span>
                        <span class="menu-arrow"></span>
                      </span>
                      <div
                        class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px"
                        ...
                        <template v-for="(menuItem2, l) in menuItem1.sub" :key="l">
                          <div class="menu-item">
                            ...
                            >
                              ...
                              <span class="menu-title">{{ $t(menuItem2.heading) }}</span>
                            </router-link>
                          </div>
                        </template>
                      </div>
                    </div>
                    <div v-if="menuItem1.heading && platforms" class="menu-item">
                      <router-link
                        class="menu-link py-3"
              ...
              <div v-if="menuItem.heading && menuItem.modalName" class="menu-item">
                <p class="menu-link py-3 mb-0" @click="setModal(menuItem.modalName)">
                  <span class="menu-icon">
                    <span class="svg-icon svg-icon-2">
                      <inline-svg src="svg/icons/lay009.svg" />
                    </span>
